...
export default function App(){
  ...
  return <div className="layout"><aside><ControlPanel {...{bandId,setBandId,radiationProfileId,setRadiationProfileId,condition,setCondition,time,setTime,maxHops,setMaxHops,showLocal,setShowLocal,showNvis,setShowNvis,nvisAvailable,showSkip,setShowSkip,showHops,setShowHops,showGlobalDx,setShowGlobalDx}} />
