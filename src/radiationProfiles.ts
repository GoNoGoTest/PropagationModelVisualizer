...
export const radiationProfiles: RadiationProfile[] = [
  ...
  { id: "low_angle_vertical_idealized", label: "Lågstrålande profil (idealiserad 2°-vertikal)", angleMinDeg: 2, angleMaxDeg: 25, nvisWeight: 0.05, lowAngleWeight: 0.9, notes: "Emphasizes very low takeoff angles.", tooltip: "2° är en idealiserad mycket låg elevationsvinkel. Verklig antenn, mark, radialer och omgivning kan göra detta betydligt sämre." },
